...
confint(tversky.lm)
@
That is, the percentage of sure choices is just shy of $50 \pm 0.05$ percentage
...
Generalised linear models can accommodate multiple predictors, as in the following
exercise.
