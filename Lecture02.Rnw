...
the errors are drawn i.i.d.\ from a normal distribution with mean 0
...
Let's first combine these datasets. (In addition to learning how to visualise data, learning to summarise, transform, and combine datasets is incredibly useful, but unfortunately out of the scope of this lecture series. See \url{https://r4ds.had.co.nz/} and \url{https://github.com/janhove/DatasetsAndGraphs} if you're interested in learning more about these topics.)
<<>>=
